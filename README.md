...
- Used GenAI as support to help enhance a code
- Create mini balls for main subject to interact with
- Implement user interaction
- Changed environment to express emotions
...
This code was written with GenAI.
